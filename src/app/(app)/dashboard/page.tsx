...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {justPaid && (
        <div className="bg-success/10 border border-success/20 rounded-2xl p-6 mb-8 flex items-start gap-4 animate-fade-in-up">
          <div className="w-10 h-10 rounded-xl bg-success/20 flex items-center justify-center shrink-0">
            <CheckCircle className="w-5 h-5 text-success" />
          </div>
          <div>
            <h2 className="font-bold text-text-primary mb-1">Payment successful — you&apos;re in!</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          ...
          >
            ...
            <p className="text-2xl sm:text-3xl font-bold font-heading text-text-primary tracking-tight leading-none mb-1">
              {stat.value}
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <Link
                  key={card.href}
                  href={card.href}
                  className={`group bg-surface border border-border rounded-2xl p-5 ${card.border} hover:shadow-card-md hover:-translate-y-0.5 transition-all duration-200`}
                >
